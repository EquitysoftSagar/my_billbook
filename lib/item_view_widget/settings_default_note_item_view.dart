...
class SettingsDefaultNoteItemView extends StatelessWidget {
  final Bills bills;
  final _noteController = TextEditingController();
  final _borderRadius = 5.0;
  final _borderWidth = 0.8;

  SettingsDefaultNoteItemView({Key key, this.bills,})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    _noteController.text = bills.settingDefaultNote;
    return Padding(
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                labelStyle: TextStyle(
                    color: MyColors.labelText, fontWeight: FontWeight.w500),
                hintStyle: TextStyle(
                    color: MyColors.labelText, fontWeight: FontWeight.w500),
                contentPadding:
  ...
  void onChanged(String value) {
    bills.settingDefaultNote = value;
  }
}
