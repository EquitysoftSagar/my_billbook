...
class SettingDefaultTermsAndConditionsItemView extends StatelessWidget {
  final Bills bills;
  final _controller = TextEditingController();
  final _borderRadius = 5.0;
  final _borderWidth = 0.8;

  SettingDefaultTermsAndConditionsItemView({Key key, this.bills}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    _controller.text = bills.settingDefaultTermsAndCondition;
    return Padding(
